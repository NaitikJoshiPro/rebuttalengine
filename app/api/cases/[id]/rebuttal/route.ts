...
export async function POST(_req: NextRequest, { params }: RouteContext) {
  ...
  const detailForEngine = {
    ...
    hotelAddress:       details?.hotelAddress ?? null,
    ...
    bookingInterface:   details?.bookingInterface ?? null,
    cardholderName:     details?.cardholderName ?? null,
    billingAddress:     details?.billingAddress ?? null,
    billingCity:        details?.billingCity ?? null,
    billingZip:         details?.billingZip ?? null,
    billingPhone:       details?.billingPhone ?? null,
    email:              details?.email ?? null,
    ipAddress:          details?.ipAddress ?? null,
    authorizationCode:  details?.authorizationCode ?? null,
    avsResult:          details?.avsResult ?? null,
    cvvResult:          details?.cvvResult ?? null,
    accertifyScore:     details?.accertifyScore ?? null,
